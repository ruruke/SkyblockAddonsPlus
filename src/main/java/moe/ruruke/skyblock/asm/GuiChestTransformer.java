...
public class GuiChestTransformer implements ITransformer {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (abstractNode instanceof MethodInsnNode && abstractNode.getOpcode() == Opcodes.INVOKESTATIC) {
                        ...
                        if (methodInsnNode.owner.equals(TransformerClass.GlStateManager.getNameRaw()) && methodInsnNode.name.equals(TransformerMethod.color.getName())) {
                            ...
                            methodNode.instructions.insertBefore(abstractNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook",
    ...
    private InsnList onRenderChestForegroundLayer() {
        ...
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook", "onRenderChestForegroundLayer",
    ...
    private InsnList updateScreen() {
        ...
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook", "updateScreen",
    ...
    private InsnList drawScreen() {
        ...
        list.add(new TypeInsnNode(Opcodes.NEW, "moe/ruruke/skyblock/asm/utils/ReturnValue"));
        list.add(new InsnNode(Opcodes.DUP)); // ReturnValue returnValue = new ReturnValue();
        list.add(new MethodInsnNode(Opcodes.INVOKESPECIAL, "moe/ruruke/skyblock/asm/utils/ReturnValue", "<init>", "()V", false));
        ...
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook", "drawScreenIslands",
                "(IILmoe/ruruke/skyblock/asm/utils/ReturnValue;)V", false)); // GuiChestHook.drawScreenIslands(returnValue);

        list.add(new VarInsnNode(Opcodes.ALOAD, 4)); // returnValue
        list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "moe/ruruke/skyblock/asm/utils/ReturnValue", "isCancelled", "()Z", false));
        LabelNode notCancelled = new LabelNode(); // if (returnValue.isCancelled())
        list.add(new JumpInsnNode(Opcodes.IFEQ, notCancelled));
        list.add(new InsnNode(Opcodes.RETURN));
        list.add(notCancelled);

        list.add(new FrameNode(Opcodes.F_APPEND, 1, new Object[]{"moe/ruruke/skyblock/asm/utils/ReturnValue"}, 0, null));
        ...
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook", "drawScreen",
    ...
    private InsnList initGui() {
        ...
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook", "initGui",
    ...
    private InsnList keyTyped() {
        ...
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook", "keyTyped",
    ...
    private InsnList handleMouseClick() {
        ...
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook", "handleMouseClick",
                "("+TransformerClass.Slot.getName()+TransformerClass.Container.getName()+TransformerClass.IInventory.getName()+"Lmoe/ruruke/skyblock/asm/utils/ReturnValue;)V", false));

        list.add(new VarInsnNode(Opcodes.ALOAD, 5));
        list.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "moe/ruruke/skyblock/asm/utils/ReturnValue", "isCancelled",
                "()Z", false));
        LabelNode notCancelled = new LabelNode(); // if (returnValue.isCancelled())
        list.add(new JumpInsnNode(Opcodes.IFEQ, notCancelled));
    ...
    private InsnList mouseClicked() {
        ...
        list.add(new VarInsnNode(Opcodes.ALOAD, 4)); // returnValue
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook", "mouseClicked",
                "(IIILmoe/ruruke/skyblock/asm/utils/ReturnValue;)V", false)); // GuiChestHook.mouseClicked(mouseX, mouseY, mouseButton);
    ...
    private InsnList mouseReleased() {
        ...
        list.add(new VarInsnNode(Opcodes.ALOAD, 4)); // returnValue
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook", "mouseReleased",
                "(Lmoe/ruruke/skyblock/asm/utils/ReturnValue;)V", false)); // GuiChestHook.mouseReleased(returnValue);
    ...
    private InsnList mouseClickMove() {
        ...
        list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "moe/ruruke/skyblock/asm/hooks/GuiChestHook", "mouseClickMove",
                "(Lmoe/ruruke/skyblock/asm/utils/ReturnValue;)V", false)); // GuiChestHook.mouseClickMove(returnValue);
