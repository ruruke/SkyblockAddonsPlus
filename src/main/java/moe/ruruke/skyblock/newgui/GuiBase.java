...
public abstract class GuiBase {
    ...
    public GuiBase openAsGUI() {
        initInternal();
        SkyblockAddonsPlus.Companion.getGuiManager().openAsGUI(this);
        return this;
    }

    public GuiBase openAsOverlay() {
        initInternal();
        SkyblockAddonsPlus.Companion.getGuiManager().openAsOverlay(this);
        return this;
    }
    ...
    public boolean isInside(float x, float y) {
        return MathUtils.Companion.isInside(x, y, minX, minY, maxX, maxY);
    }
