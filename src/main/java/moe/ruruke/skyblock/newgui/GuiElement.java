...
import moe.ruruke.skyblock.newgui.sizes.parent.ParentOffsetSize;
import moe.ruruke.skyblock.newgui.sizes.screen.ScreenPercentageSize;
import moe.ruruke.skyblock.newgui.sizes.staticc.StaticSize;
...
public abstract class GuiElement<T extends GuiElement> {
    ...
    public boolean isInside(float x, float y) {
        return MathUtils.Companion.isInside(x, y, getX(), getY(), getX2(), getY2());
    }
