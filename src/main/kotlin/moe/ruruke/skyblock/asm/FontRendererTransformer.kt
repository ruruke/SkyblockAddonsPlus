...
class FontRendererTransformer : ITransformer {
    ...
    override fun getClassName(): Array<String> {
        return arrayOf(TransformerClass.FontRenderer.getTransformerName(), "club.sk1er.patcher.hooks.FontRendererHook")
    }
    ...
    override fun transform(classNode: ClassNode?, name: String?) {
        for (methodNode in classNode!!.methods) {
            ...
            if (TransformerMethod.renderChar.matches(methodNode) || methodNode.name == "renderChar") {
                ...
                var fieldInsnNode: FieldInsnNode? = null
                var nextNode: AbstractInsnNode? = null
