...
//        return arrayOf(TransformerClass.GuiChest.getTransformerName())
//    }
//
//
...
//                        if (methodInsnNode.owner == TransformerClass.GlStateManager.getNameRaw() && methodInsnNode.name == TransformerMethod.color.name) {
...
//                        val methodInsnNode = abstractNode
//                        if (methodInsnNode.owner == TransformerClass.FontRenderer.getNameRaw() && methodInsnNode.name == TransformerMethod.drawString.name) {
//                            methodNode.instructions.insertBefore(
//                                abstractNode, MethodInsnNode(
...
//        list.add(
//            MethodInsnNode(
//                Opcodes.INVOKESPECIAL, TransformerClass.GuiContainer.getNameRaw(), TransformerMethod.updateScreen.name,
//                "()V", false
//            )
//        ) // super.updateScreen();
//
...
//            MethodInsnNode(
//                Opcodes.INVOKESPECIAL,
//                TransformerClass.GuiContainer.getNameRaw(),
//                TransformerMethod.drawScreen.name,
//                "(IIF)V",
//                false
//            )
//        )
...
//                Opcodes.INVOKESPECIAL,
//                TransformerClass.GuiContainer.getNameRaw(),
//                TransformerMethod.initGui.name,
//                "()V",
//                false
//            )
//        )
...
//                Opcodes.INVOKESPECIAL,
//                TransformerClass.GuiContainer.getNameRaw(),
//                TransformerMethod.keyTyped.name,
//                "(CI)V",
//                false
//            )
//        )
...
//                Opcodes.INVOKESPECIAL,
//                TransformerClass.GuiContainer.getNameRaw(),
//                TransformerMethod.handleMouseClick.name,
...
//                Opcodes.INVOKESPECIAL,
//                TransformerClass.GuiContainer.getNameRaw(),
//                TransformerMethod.mouseClicked.name,
//                "(III)V",
//                false
//            )
//        )
...
//                Opcodes.INVOKESPECIAL,
//                TransformerClass.GuiContainer.getNameRaw(),
//                TransformerMethod.mouseReleased.name,
//                "(III)V",
//                false
//            )
//        )
...
//                Opcodes.INVOKESPECIAL,
//                TransformerClass.GuiContainer.getNameRaw(),
//                TransformerMethod.mouseClickMove.name,
//                "(IIIJ)V",
//                false
//            )
//        )
