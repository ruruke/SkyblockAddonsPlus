...
enum class TransformerMethod @JvmOverloads constructor(
    deobfMethod: String?,
    seargeMethod: String?,
    notchMethod18: String?,
    seargeDescription: String?,
    notchDescription: String? = seargeDescription,
    ...
    drawSlot(
        ...
        "(" + TransformerClass.Slot.getName() + ")V"
    ),
    ...
    actionPerformed(
        ...
        "(" + TransformerClass.GuiButton.getName() + ")V"
    ),
    ...
    renderToolTip(
        ...
        "(" + TransformerClass.ItemStack.getName() + "II)V"
    ),
    handleComponentClick(
        "handleComponentClick",
        "func_175276_a",
        "a",
        "(Lnet/minecraft/util/IChatComponent;)Z",
        "(" + TransformerClass.IChatComponent.getName() + ")Z"
    ),
    ...
    renderItemModelTransform(
        ...
        "func_175040_a",
        "a",
        "(Lnet/minecraft/item/ItemStack;Lnet/minecraft/client/resources/model/IBakedModel;Lnet/minecraft/client/renderer/block/model/ItemCameraTransforms\$TransformType;)V",
    ...
    renderModel_IBakedModel_ItemStack(
        "renderModel",
        "func_175036_a",
        "a",
    ...
    renderModel_IBakedModel_I_ItemStack(
        "renderModel",
        "func_175045_a",
        "a",
    ...
    getNormalizedVolume(
        ...
        "(" + TransformerClass.ISound.getName() + TransformerClass.SoundPoolEntry.getName() + TransformerClass.SoundCategory.getName() + ")F"
    ),
    ...
    bindTexture(
        ...
        "(" + TransformerClass.ResourceLocation.getName() + ")V"
    ),
    ...
    isPotionActive(
        ...
        "(" + TransformerClass.Potion.getName() + ")Z"
    ),
    setCurrentItemOrArmor(
        ...
        "(I" + TransformerClass.ItemStack.getName() + ")V"
    ),
    ...
    dropOneItem(
        ...
        "(Z)" + TransformerClass.EntityItem.getName()
    ),
    ...
    getNightVisionBrightness(
        ...
        "(" + TransformerClass.EntityLivingBase.getName() + "F)F"
    ),
    ...
    printChatMessageWithOptionalDeletion(
        ...
        "(" + TransformerClass.IChatComponent.getName() + "I)V"
    ),
    ...
    handleSetSlot(
        ...
        "func_147266_a",
        "a",
        "(Lnet/minecraft/network/play/server/S2FPacketSetSlot;)V",
        "(" + TransformerClass.S2FPacketSetSlot.getName() + ")V"
    ),
    handleWindowItems(
        "handleWindowItems",
        "func_147241_a",
        "a",
        "(Lnet/minecraft/network/play/server/S30PacketWindowItems;)V",
        "(" + TransformerClass.S30PacketWindowItems.getName() + ")V"
    ),
    ...
    clickBlock(
        ...
        "(" + TransformerClass.BlockPos.getName() + TransformerClass.EnumFacing.getName() + ")Z"
    ),
    ...
    windowClick(
        ...
        "(IIII" + TransformerClass.EntityPlayer.getName() + ")" + TransformerClass.ItemStack.getName()
    ),
    ...
    rotateCorpse(
        ...
        "(" + TransformerClass.EntityLivingBase.getName() + "FFF)V"
    ),
    isWearing(
        "isWearing",
        "func_175148_a",
        ...
        "(" + TransformerClass.EnumPlayerModelParts.getName() + ")Z"
    ),
    renderModel_RendererLivingEntity(
        "renderModel",
        "func_77036_a",
        "a",
        "(Lnet/minecraft/entity/EntityLivingBase;FFFFFF)V",
        "(" + TransformerClass.EntityLivingBase.getName() + "FFFFFF)V"
    ),
    setScoreTeamColor(
        "setScoreTeamColor",
        "func_177088_c",
        ...
        "(" + TransformerClass.EntityLivingBase.getName() + ")Z"
    ),
    ...
    shouldRender(
        ...
        "(" + TransformerClass.Entity.getName() + TransformerClass.ICamera.getName() + "DDD)Z"
    ),
    ...
    playSound(
        ...
        "(" + TransformerClass.ISound.getName() + ")V"
    ),
    ...
    renderTileEntityAt(
        ...
        "func_180535_a",
        "a",
        "(Lnet/minecraft/tileentity/TileEntityEnderChest;DDDFI)V",
        "(" + TransformerClass.TileEntityEnderChest.getName() + "DDDFI)V"
    ),
    ...
    addPotionEffect(
        ...
        "(" + TransformerClass.PotionEffect.getName() + ")V"
    ),

    // Constructor
    _init("<init>", "<init>", "<init>", "()V"),
    ...
    private var exceptions: Array<String>? = null
    ...
    fun matches(methodInsnNode: MethodInsnNode): Boolean {
        return this._name == methodInsnNode.name && this.description == methodInsnNode.desc
    }

    fun matches(methodNode: MethodNode): Boolean {
        return this._name == methodNode.name && (this.description == methodNode.desc || this == TransformerMethod._init)
    }
}