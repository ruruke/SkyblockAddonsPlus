...
enum class Feature(
    ...
    private val guiFeatureData: GuiFeatureData?,
    private val defaultDisabled: Boolean,
    vararg settings: EnumUtils.FeatureSetting
) {
    DROP_CONFIRMATION(
        1,
        "settings.itemDropConfirmation",
        GuiFeatureData(ColorCode.RED, true),
        true,
        EnumUtils.FeatureSetting.ENABLED_IN_OTHER_GAMES
    ),
    SHOW_BACKPACK_PREVIEW(
        3,
        "settings.showBackpackPreview",
        null,
        false,
        EnumUtils.FeatureSetting.BACKPACK_STYLE,
        EnumUtils.FeatureSetting.SHOW_ONLY_WHEN_HOLDING_SHIFT,
        EnumUtils.FeatureSetting.MAKE_INVENTORY_COLORED,
        EnumUtils.FeatureSetting.ENABLE_CAKE_BAG_PREVIEW,
        EnumUtils.FeatureSetting.ENABLE_PERSONAL_COMPACTOR_PREVIEW,
        EnumUtils.FeatureSetting.SHOW_ENDER_CHEST_PREVIEW
    ),
    HIDE_BONES(4, "settings.hideSkeletonHatBones", null, false),
    SKELETON_BAR(5, "settings.skeletonHatBonesBar", GuiFeatureData(EnumUtils.DrawType.SKELETON_BAR), false),
    HIDE_FOOD_ARMOR_BAR(6, "settings.hideFoodAndArmor", null, false),
    FULL_INVENTORY_WARNING(
        7,
        "settings.fullInventoryWarning",
        GuiFeatureData(ColorCode.RED),
        false,
        EnumUtils.FeatureSetting.REPEATING
    ),
    SHOW_REFORGE_OVERLAY(10, "settings.showReforgeOverlay", null, false),
    MINION_STOP_WARNING(11, "settings.minionStopWarning", GuiFeatureData(ColorCode.RED), true),
    HIDE_HEALTH_BAR(13, "settings.hideHealthBar", null, true),
    DOUBLE_DROP_IN_OTHER_GAMES(14, null, false),
    MINION_FULL_WARNING(15, "settings.fullMinionWarning", GuiFeatureData(ColorCode.RED), false),
    ...
    MANA_BAR(19, "settings.manaBar", GuiFeatureData(EnumUtils.DrawType.BAR, ColorCode.BLUE), false),
    MANA_TEXT(20, "settings.manaNumber", GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.BLUE), false),
    HEALTH_BAR(
        21,
        "settings.healthBar",
        GuiFeatureData(EnumUtils.DrawType.BAR, ColorCode.RED),
        true,
        EnumUtils.FeatureSetting.CHANGE_BAR_COLOR_WITH_POTIONS,
        EnumUtils.FeatureSetting.HEALTH_PREDICTION
    ),
    HEALTH_TEXT(22, "settings.healthNumber", GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.RED), false),
    DEFENCE_ICON(
        23,
        "settings.defenseIcon",
        GuiFeatureData(EnumUtils.DrawType.DEFENCE_ICON),
        false,
        EnumUtils.FeatureSetting.USE_VANILLA_TEXTURE
    ),
    DEFENCE_TEXT(
        24,
        "settings.defenseNumber",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GREEN),
        false,
        EnumUtils.FeatureSetting.OTHER_DEFENCE_STATS
    ),
    DEFENCE_PERCENTAGE(
        25,
        "settings.defensePercentage",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GREEN),
        true
    ),
    HEALTH_UPDATES(
        ...
        GuiFeatureData(EnumUtils.DrawType.TEXT),
        false
    ),  // Health updates all credit to DidiSkywalker#9975
    HIDE_PLAYERS_IN_LOBBY(27, "settings.hidePlayersInLobby", null, true),
    DARK_AUCTION_TIMER(
        28,
        "settings.darkAuctionTimer",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GOLD),
        false,
        EnumUtils.FeatureSetting.ENABLED_IN_OTHER_GAMES
    ),
    ITEM_PICKUP_LOG(29, "settings.itemPickupLog", GuiFeatureData(EnumUtils.DrawType.PICKUP_LOG), false),
    SHOW_DARK_AUCTION_TIMER_IN_OTHER_GAMES(33, null, false),
    SHOW_ITEM_ANVIL_USES(34, "settings.showItemAnvilUses", GuiFeatureData(ColorCode.RED, true), false),
    DONT_RESET_CURSOR_INVENTORY(37, "settings.dontResetCursorInventory", null, false),
    LOCK_SLOTS(38, "settings.lockSlots", null, false),
    SUMMONING_EYE_ALERT(39, "settings.summoningEyeAlert", GuiFeatureData(ColorCode.RED), false),
    MAKE_ENDERCHESTS_GREEN_IN_END(40, "settings.makeEnderchestsInEndGreen", GuiFeatureData(ColorCode.GREEN), false),
    STOP_DROPPING_SELLING_RARE_ITEMS(
        42,
        "settings.stopDroppingSellingRareItems",
        GuiFeatureData(ColorCode.RED, true),
        false
    ),
    ...
    REPLACE_ROMAN_NUMERALS_WITH_NUMBERS(
        45,
        "settings.replaceRomanNumeralsWithNumbers",
        null,
        true,
        EnumUtils.FeatureSetting.DONT_REPLACE_ROMAN_NUMERALS_IN_ITEM_NAME
    ),
    ...
    ENCHANTMENT_LORE_PARSING(
        52,
        "settings.enchantmentLoreParsing",
        null,
        false,
        EnumUtils.FeatureSetting.HIGHLIGHT_ENCHANTMENTS,
        EnumUtils.FeatureSetting.PERFECT_ENCHANT_COLOR,
        EnumUtils.FeatureSetting.GREAT_ENCHANT_COLOR,
        EnumUtils.FeatureSetting.GOOD_ENCHANT_COLOR,
        EnumUtils.FeatureSetting.POOR_ENCHANT_COLOR,
        EnumUtils.FeatureSetting.COMMA_ENCHANT_COLOR,
        EnumUtils.FeatureSetting.ENCHANT_LAYOUT,
        EnumUtils.FeatureSetting.HIDE_ENCHANTMENT_LORE,
        EnumUtils.FeatureSetting.HIDE_GREY_ENCHANTS
    ),
    SHOW_ITEM_COOLDOWNS(53, "settings.showItemCooldowns", null, false),
    SKILL_DISPLAY(
        54,
        "settings.collectionDisplay",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.AQUA),
        false,
        EnumUtils.FeatureSetting.SKILL_ACTIONS_LEFT_UNTIL_NEXT_LEVEL,
        EnumUtils.FeatureSetting.SHOW_SKILL_PERCENTAGE_INSTEAD_OF_XP,
        EnumUtils.FeatureSetting.SHOW_SKILL_XP_GAINED,
        EnumUtils.FeatureSetting.ABBREVIATE_SKILL_XP_DENOMINATOR
    ),
    SPEED_PERCENTAGE(55, "settings.speedPercentage", GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.WHITE), false),
    SLAYER_INDICATOR(
        57,
        "settings.revenantIndicator",
        GuiFeatureData(EnumUtils.DrawType.REVENANT_PROGRESS, ColorCode.AQUA),
        true
    ),
    SPECIAL_ZEALOT_ALERT(58, "settings.specialZealotAlert", GuiFeatureData(ColorCode.RED), false),
    ...
    POWER_ORB_STATUS_DISPLAY(
        65,
        "settings.powerOrbDisplay",
        GuiFeatureData(EnumUtils.DrawType.POWER_ORB_DISPLAY, null),
        false,
        EnumUtils.FeatureSetting.POWER_ORB_DISPLAY_STYLE
    ),
    ZEALOT_COUNTER(
        66,
        "settings.zealotCounter",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.DARK_AQUA),
        false,
        EnumUtils.FeatureSetting.ZEALOT_SPAWN_AREAS_ONLY
    ),
    TICKER_CHARGES_DISPLAY(67, "settings.tickerChargesDisplay", GuiFeatureData(EnumUtils.DrawType.TICKER, null), false),
    TAB_EFFECT_TIMERS(
        68,
        "settings.tabEffectTimers",
        GuiFeatureData(EnumUtils.DrawType.TAB_EFFECT_TIMERS, ColorCode.WHITE),
        true
    ),
    NO_ARROWS_LEFT_ALERT(69, "settings.noArrowsLeftAlert", GuiFeatureData(ColorCode.RED), false),
    CAKE_BAG_PREVIEW(71, "settings.showCakeBagPreview", null, true),
    REPEAT_FULL_INVENTORY_WARNING(73, null, true),
    SHOW_BROKEN_FRAGMENTS(75, "settings.showBrokenFragments", GuiFeatureData(ColorCode.RED, true), false),
    SKYBLOCK_ADDONS_BUTTON_IN_PAUSE_MENU(76, "settings.skyblockAddonsButtonInPauseMenu", null, false),
    SHOW_TOTAL_ZEALOT_COUNT(
        77,
        "settings.showTotalZealotCount",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.DARK_AQUA),
        true,
        EnumUtils.FeatureSetting.ZEALOT_SPAWN_AREAS_ONLY
    ),
    SHOW_SUMMONING_EYE_COUNT(
        78,
        "settings.showSummoningEyeCount",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.DARK_AQUA),
        true,
        EnumUtils.FeatureSetting.ZEALOT_SPAWN_AREAS_ONLY
    ),
    ...
    BIRCH_PARK_RAINMAKER_TIMER(
        81,
        "settings.birchParkRainmakerTimer",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.DARK_AQUA),
        false
    ),
    DISCORD_RPC(
        ...
        null,
        true,
        EnumUtils.FeatureSetting.DISCORD_RP_DETAILS,
        EnumUtils.FeatureSetting.DISCORD_RP_STATE
    ),
    ENDSTONE_PROTECTOR_DISPLAY(
        84,
        "settings.endstoneProtectorDisplay",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.WHITE),
        false
    ),
    FANCY_WARP_MENU(85, "settings.fancyWarpMenu", null, false),
    HIDE_GREY_ENCHANTS(87, "settings.hideGreyEnchants", null, false),
    LEGENDARY_SEA_CREATURE_WARNING(88, "settings.legendarySeaCreatureWarning", GuiFeatureData(ColorCode.RED), false),
    ...
    BAIT_LIST(
        93,
        "settings.baitListDisplay",
        GuiFeatureData(EnumUtils.DrawType.BAIT_LIST_DISPLAY, ColorCode.AQUA),
        true
    ),
    ...
    CHANGE_ZEALOT_COLOR(96, "settings.changeZealotColor", GuiFeatureData(ColorCode.LIGHT_PURPLE), true),
    ...
    DUNGEONS_MAP_DISPLAY(
        99,
        "settings.dungeonMapDisplay",
        GuiFeatureData(EnumUtils.DrawType.DUNGEONS_MAP, ColorCode.BLACK),
        false,
        EnumUtils.FeatureSetting.ROTATE_MAP,
        EnumUtils.FeatureSetting.CENTER_ROTATION_ON_PLAYER,
        EnumUtils.FeatureSetting.SHOW_PLAYER_HEADS_ON_MAP,
        EnumUtils.FeatureSetting.MAP_ZOOM
    ),
    ...
    MAKE_DROPPED_ITEMS_GLOW(
        102,
        "settings.glowingDroppedItems",
        null,
        false,
        EnumUtils.FeatureSetting.SHOW_GLOWING_ITEMS_ON_ISLAND
    ),
    MAKE_DUNGEON_TEAMMATES_GLOW(103, "settings.outlineDungeonTeammates", null, false),
    SHOW_BASE_STAT_BOOST_PERCENTAGE(
        104,
        "settings.baseStatBoostPercentage",
        GuiFeatureData(ColorCode.RED, true),
        false,
        EnumUtils.FeatureSetting.COLOUR_BY_RARITY
    ),
    ...
    SHOW_HEALING_CIRCLE_WALL(
        107,
        "settings.showHealingCircleWall",
        GuiFeatureData(ColorCode.GREEN, false),
        true,
        EnumUtils.FeatureSetting.HEALING_CIRCLE_OPACITY
    ),
    ...
    SHOW_ITEM_DUNGEON_FLOOR(110, "settings.showItemDungeonFloor", GuiFeatureData(ColorCode.RED, true), false),
    SHOW_DUNGEON_MILESTONE(
        111,
        "settings.showDungeonMilestone",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.YELLOW),
        false
    ),
    DUNGEONS_COLLECTED_ESSENCES_DISPLAY(
        112,
        "settings.dungeonsCollectedEssencesDisplay",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.YELLOW),
        false,
        EnumUtils.FeatureSetting.SHOW_SALVAGE_ESSENCES_COUNTER,
        EnumUtils.FeatureSetting.RESET_SALVAGED_ESSENCES_AFTER_LEAVING_MENU
    ),
    STOP_BONZO_STAFF_SOUNDS(113, "settings.stopBonzoStaffSounds", null, true),
    SHOW_RARITY_UPGRADED(114, "settings.showRarityUpgraded", GuiFeatureData(ColorCode.LIGHT_PURPLE, true), false),
    SKILL_ACTIONS_LEFT_UNTIL_NEXT_LEVEL(115, null, true),
    REVENANT_SLAYER_TRACKER(
        116,
        "settings.revenantSlayerTracker",
        GuiFeatureData(EnumUtils.DrawType.SLAYER_TRACKERS, ColorCode.WHITE),
        false,
        EnumUtils.FeatureSetting.COLOUR_BY_RARITY,
        EnumUtils.FeatureSetting.TEXT_MODE,
        EnumUtils.FeatureSetting.HIDE_WHEN_NOT_IN_CRYPTS
    ),
    TARANTULA_SLAYER_TRACKER(
        117,
        "settings.tarantulaSlayerTracker",
        GuiFeatureData(EnumUtils.DrawType.SLAYER_TRACKERS, ColorCode.WHITE),
        false,
        EnumUtils.FeatureSetting.COLOUR_BY_RARITY,
        EnumUtils.FeatureSetting.TEXT_MODE,
        EnumUtils.FeatureSetting.HIDE_WHEN_NOT_IN_SPIDERS_DEN
    ),
    SVEN_SLAYER_TRACKER(
        118,
        "settings.svenSlayerTracker",
        GuiFeatureData(EnumUtils.DrawType.SLAYER_TRACKERS, ColorCode.WHITE),
        false,
        EnumUtils.FeatureSetting.COLOUR_BY_RARITY,
        EnumUtils.FeatureSetting.TEXT_MODE,
        EnumUtils.FeatureSetting.HIDE_WHEN_NOT_IN_CASTLE
    ),
    ...
    DRAGON_STATS_TRACKER(
        125,
        "settings.dragonStatsTracker",
        GuiFeatureData(EnumUtils.DrawType.DRAGON_STATS_TRACKER, ColorCode.WHITE),
        true,
        EnumUtils.FeatureSetting.COLOUR_BY_RARITY,
        EnumUtils.FeatureSetting.DRAGONS_NEST_ONLY
    ),
    ...
    DUNGEON_DEATH_COUNTER(
        136,
        "settings.dungeonDeathCounter",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.RED),
        true
    ),
    SHOW_PERSONAL_COMPACTOR_PREVIEW(137, null, false),
    ROCK_PET_TRACKER(138, "settings.rockPetTracker", GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GRAY), true),
    DOLPHIN_PET_TRACKER(
        139,
        "settings.dolphinPetTracker",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.AQUA),
        true
    ),
    SHOW_DUNGEON_TEAMMATE_NAME_OVERLAY(140, "settings.dungeonsTeammateNameOverlay", null, false),
    SHOW_STACKING_ENCHANT_PROGRESS(141, "settings.stackingEnchantProgress", GuiFeatureData(ColorCode.RED, true), false),
    DUNGEONS_SECRETS_DISPLAY(
        142,
        "settings.dungeonsSecretsDisplay",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GRAY),
        false
    ),
    SKILL_PROGRESS_BAR(143, "settings.skillProgressBar", GuiFeatureData(EnumUtils.DrawType.BAR, ColorCode.GREEN), true),
    ...
    SHOW_SWORD_KILLS(149, "settings.showSwordKills", GuiFeatureData(ColorCode.RED, true), false),
    ...
    DRILL_FUEL_BAR(160, "settings.drillFuelBar", GuiFeatureData(EnumUtils.DrawType.BAR, ColorCode.DARK_GREEN), false),
    DRILL_FUEL_TEXT(
        161,
        "settings.drillFuelNumber",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.DARK_GREEN),
        false
    ),
    FISHING_PARTICLE_OVERLAY(
        162,
        "settings.fishingParticleOverlay",
        GuiFeatureData(ColorCode.WHITE),
        false,
        EnumUtils.FeatureSetting.BIGGER_WAKE
    ),
    COOLDOWN_PREDICTION(164, "settings.cooldownPrediction", null, false),
    ENCHANTMENT_PERFECT_COLOR(165, "enchants.superTier", GuiFeatureData(ColorCode.CHROMA, true), false),
    ENCHANTMENT_GREAT_COLOR(166, "enchants.highTier", GuiFeatureData(ColorCode.GOLD, true), false),
    ENCHANTMENT_GOOD_COLOR(167, "enchants.midTier", GuiFeatureData(ColorCode.BLUE, true), false),
    ENCHANTMENT_POOR_COLOR(168, "enchants.lowTier", GuiFeatureData(ColorCode.GRAY, true), false),
    LEG_MONKEY_LEVEL_100(169, "settings.legendaryMonkeyLevel100", null, true),
    BIGGER_WAKE(170, "settings.biggerWake", null, false),
    ENCHANTMENT_COMMA_COLOR(171, "enchants.commas", GuiFeatureData(ColorCode.BLUE, true), false),
    REFORGE_FILTER(172, "settings.reforgeFilter", null, false),
    TREVOR_TRACKED_ENTITY_PROXIMITY_INDICATOR(
        173,
        "settings.trevorTheTrapper.trackedEntityProximityIndicator",
        GuiFeatureData(EnumUtils.DrawType.PROXIMITY_INDICATOR, null),
        false
    ),
    ...
    TREVOR_THE_TRAPPER_FEATURES(
        177,
        "settings.trevorTheTrapper.title",
        null,
        false,
        EnumUtils.FeatureSetting.TREVOR_TRACKED_ENTITY_PROXIMITY_INDICATOR,
        EnumUtils.FeatureSetting.TREVOR_HIGHLIGHT_TRACKED_ENTITY,
        EnumUtils.FeatureSetting.TREVOR_SHOW_QUEST_COOLDOWN
    ),
    FETCHUR_TODAY(
        178,
        "settings.fetchurToday",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GREEN),
        false,
        EnumUtils.FeatureSetting.SHOW_FETCHUR_ITEM_NAME,
        EnumUtils.FeatureSetting.SHOW_FETCHUR_ONLY_IN_DWARVENS,
        EnumUtils.FeatureSetting.SHOW_FETCHUR_INVENTORY_OPEN_ONLY,
    ...
    WARN_WHEN_FETCHUR_CHANGES(182, "settings.warnWhenFetchurChanges", GuiFeatureData(ColorCode.RED), true),
    ...
    VOIDGLOOM_SLAYER_TRACKER(
        186,
        "settings.voidgloomSlayerTracker",
        GuiFeatureData(EnumUtils.DrawType.SLAYER_TRACKERS, ColorCode.WHITE),
        false,
        EnumUtils.FeatureSetting.COLOUR_BY_RARITY,
        EnumUtils.FeatureSetting.TEXT_MODE,
        EnumUtils.FeatureSetting.HIDE_WHEN_NOT_IN_END
    ),
    ...
    OVERFLOW_MANA(
        191,
        "settings.showOverflowManaNumber",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.DARK_AQUA),
        false
    ),
    ...
    JUNGLE_AXE_COOLDOWN(
        193,
        "settings.axeCooldownIndicator",
        null,
        true,
        EnumUtils.FeatureSetting.COOLDOWN_PREDICTION,
        EnumUtils.FeatureSetting.LEVEL_100_LEG_MONKEY
    ),
    ...
    ENTITY_OUTLINES(
        196,
        "settings.entityOutlines",
        null,
        false,
        EnumUtils.FeatureSetting.DUNGEON_PLAYER_GLOW,
        EnumUtils.FeatureSetting.ITEM_GLOW,
        EnumUtils.FeatureSetting.TREVOR_HIGHLIGHT_TRACKED_ENTITY
    ),
    EFFECTIVE_HEALTH_TEXT(
        197,
        "settings.effectiveHealthNumber",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.DARK_GREEN),
        false
    ),
    ...
    SPIRIT_SCEPTRE_DISPLAY(
        202,
        "settings.showSpiritSceptreDisplay",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GRAY),
        false,
        EnumUtils.FeatureSetting.DISABLE_SPIRIT_SCEPTRE_MESSAGES
    ),
    DISABLE_SPIRIT_SCEPTRE_MESSAGES(203, null, false),
    FARM_EVENT_TIMER(
        204,
        "settings.jacobsContestTimer",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GOLD),
        false,
        EnumUtils.FeatureSetting.ENABLED_IN_OTHER_GAMES
    ),
    ...
    PLAYER_SYMBOLS_IN_CHAT(
        216,
        "settings.showPlayerSymbolsInChat",
        null,
        false,
        EnumUtils.FeatureSetting.SHOW_PROFILE_TYPE,
        EnumUtils.FeatureSetting.SHOW_NETHER_FACTION
    ),
    CRIMSON_ARMOR_ABILITY_STACKS(
        217,
        "settings.crimsonArmorAbilityStacks",
        GuiFeatureData(EnumUtils.DrawType.TEXT, ColorCode.GOLD),
        false
    ),
    HIDE_TRUE_DEFENSE(218, "settings.hideTrueDefense", GuiFeatureData(ColorCode.RED), false),
    ...
    @Deprecated("")
    CHROMA_FADE_WIDTH(-1, "settings.chromaFadeWidth", null, false),
    ...
    constructor(id: Int, translationKey: String?, defaultDisabled: Boolean) : this(
        id,
        translationKey,
        null,
        defaultDisabled
    ...
    init {
        ...
        val registeredFeatureIDs: MutableSet<Int> = SkyblockAddonsPlus.registeredFeatureIDs
        if (id != -1 && registeredFeatureIDs.contains(id)) {
            throw RuntimeException("Multiple features have the same IDs!")
        } else {
...
//            }
    ...
    val isActualFeature: Boolean
        get() = id != -1 && getMessage() != null && !SETTINGS.contains(
            this
        )

    fun getMessage(vararg variables: String?): String? {
        if (translationKey != null) {
            return Translations.getMessage(translationKey, *variables as Array<Any?>)
        }
...
//            }
    ...
    companion object {
         ...
         */
        val SETTINGS: Set<Feature> = Sets.newHashSet(
            DOUBLE_DROP_IN_OTHER_GAMES,
            ...
            ENABLE_MESSAGE_WHEN_MINING_DEEP_CAVERNS,
            ENABLE_MESSAGE_WHEN_MINING_NETHER,
            CAKE_BAG_PREVIEW,
            REPEAT_FULL_INVENTORY_WARNING,
            DOUBLE_WARP,
            REPEAT_SLAYER_BOSS_WARNING,
            ROTATE_MAP,
            CENTER_ROTATION_ON_PLAYER,
            MAP_ZOOM,
            BASE_STAT_BOOST_COLOR_BY_RARITY,
            SHOW_PLAYER_HEADS_ON_MAP,
            SHOW_GLOWING_ITEMS_ON_ISLAND,
            SKILL_ACTIONS_LEFT_UNTIL_NEXT_LEVEL,
            REVENANT_COLOR_BY_RARITY,
            TARANTULA_COLOR_BY_RARITY,
            SVEN_COLOR_BY_RARITY,
            REVENANT_TEXT_MODE,
            TARANTULA_TEXT_MODE,
            SVEN_TEXT_MODE,
            DRAGON_STATS_TRACKER_COLOR_BY_RARITY,
            HIDE_WHEN_NOT_IN_CASTLE,
            HIDE_WHEN_NOT_IN_SPIDERS_DEN,
            HIDE_WHEN_NOT_IN_CRYPTS,
            SHOW_PERSONAL_COMPACTOR_PREVIEW,
            SHOW_SKILL_PERCENTAGE_INSTEAD_OF_XP,
            SHOW_SKILL_XP_GAINED,
            SHOW_SALVAGE_ESSENCES_COUNTER,
            HEALING_CIRCLE_OPACITY,
            COOLDOWN_PREDICTION,
            ENCHANTMENTS_HIGHLIGHT,
            ENCHANTMENT_COMMA_COLOR,
            ENCHANTMENT_PERFECT_COLOR,
            ENCHANTMENT_GREAT_COLOR,
            ENCHANTMENT_GOOD_COLOR,
            ENCHANTMENT_POOR_COLOR,
            BIGGER_WAKE,
            LEG_MONKEY_LEVEL_100,
            HIDE_ENCHANT_DESCRIPTION,
            HIDE_GREY_ENCHANTS,
            TREVOR_TRACKED_ENTITY_PROXIMITY_INDICATOR,
            TREVOR_HIGHLIGHT_TRACKED_ENTITY,
            TREVOR_SHOW_QUEST_COOLDOWN,
            SHOW_FETCHUR_ONLY_IN_DWARVENS,
            SHOW_FETCHUR_ITEM_NAME,
            SHOW_FETCHUR_INVENTORY_OPEN_ONLY,
            WARN_WHEN_FETCHUR_CHANGES,
            STOP_ONLY_RAT_SQUEAK,
            SHOW_ENDER_CHEST_PREVIEW,
            HEALTH_PREDICTION,
            ABBREVIATE_SKILL_XP_DENOMINATOR,
            OTHER_DEFENCE_STATS,
         ...
         */
        val generalTabFeatures: Set<Feature> = LinkedHashSet(
            Arrays.asList(
                TEXT_STYLE,
                WARNING_TIME,
                CHROMA_SPEED,
                CHROMA_MODE,
                CHROMA_SIZE,
                TURN_ALL_FEATURES_CHROMA,
                CHROMA_SATURATION,
                CHROMA_BRIGHTNESS,
                USE_NEW_CHROMA_EFFECT,
                DEVELOPER_MODE
            )
        )
