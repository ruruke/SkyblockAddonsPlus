...
/**
 * Contains all the Skyblock locations (I hope).
 */
enum class Location {
...
//        this.discordIconKey = discordIconKey
    ...
    constructor(scoreboardName: String) {
        ...
        val NO_DISCORD_RPC: Set<String> = Sets.newHashSet(
            "ISLAND",
            "BAZAAR",
            "DEEP_CAVERNS",
            "GUNPOWDER_MINES",
            ...
            "CRIMSON_ISLE",
            "MINION_SHOP",
            "DRAGONTAIL_BLACKSMITH",
            "DRAGONTAIL_BANK",
            "DRAGONTAIL_BAZAAR",
            "DRAGONTAIL_AUCTION_HOUS",
            "DRAGONTAIL_TOWNSQUARE",
            "DRAGONTAIL",
            "RUINS_OF_ASHFANG",
            "ODGERS_HUT",
            "MAGMA_CHAMBER",
